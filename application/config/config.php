...
$config['base_url'] = ($app_base_url !== false && $app_base_url !== '')
	? rtrim($app_base_url, '/') . '/'
	: 'https://crei.edu.ar/integracion/';
...
|
*/
$index_page = getenv('APP_INDEX_PAGE');
$config['index_page'] = ($index_page !== false) ? $index_page : 'index.php';
