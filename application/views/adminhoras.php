            ...
            <div class="box-inner">
            	...
            	<div class="box-content">
                    ...
                    <div class="form-group">
						...
						echo form_open( 'administracion/horas', $attributes ); ?>
...
<div class="ch-container">
	<div class="row">
        <div class="box col-md-12">
			<div class="box-inner">
				<div class="box-header well" data-original-title="">
					<h2><i class="glyphicon glyphicon-user"></i> Administración de horas cargadas</h2>
						<div class="box-icon">
							...
							<div class="scrollable">
								<table class="table table-striped table-bordered bootstrap-datatable datatable responsive dataTable" id="DataTables_Table_0" aria-describedby="DataTables_Table_0_info">
									<thead>
										...
										<th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Role: activate to sort column ascending" style="width: 88px;">Hora de inicio</th>
										<th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Role: activate to sort column ascending" style="width: 88px;">Hora de fin</th>
					...
					if (!isset($horas) or $horas==false) {
						...
						$i = 1;
							...
							foreach ($horas as $hora) {
								...
								echo '<td class="center ">'.$hora->alumno.'</td>';
								echo '<td class="center ">'.date('d-m-Y',strtotime($hora->fecha_inicio)).'</td>';
								echo '<td class="center ">'.date('H:i',strtotime($hora->fecha_inicio)).'</td>';
								echo '<td class="center ">'.date('H:i',strtotime($hora->fecha_fin)).'</td>';
								echo '<td class="center ">

										<a class="btn btn-info btn-editalumno" href="'. base_url().'index.php/principal/index?id_actividades='. $hora->id_actividades.'" id="'.$hora->id_actividades.'">
										<i class="glyphicon glyphicon-edit icon-white"></i>
										Editar
										</a>
										<a class="btn btn-danger btn-deleterow" href="#" id="'.$hora->id_actividades.'">
...
?>
	<div class="modal fade" id="del" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                		...
                		<p>Está a punto de eliminar la actividad del alumno: <span class="nombre-alumno"></span></p>
                ...
                <div class="modal-footer">
						...
						<div>
                	<form action="<?php echo base_url().'index.php/administracion/bajahoras';?>" class="form-horizontal" method="post" accept-charset="utf-8">
                    	<a href="#" class="btn btn-default cancelar" data-dismiss="modal">Cancelar</a>
						 <input type="hidden" id="id_actividades" name="id_actividades"  maxlength="100" size="50"  class="form-control hidden">
    	...
    	var id = $(this).attr('id');
                   ...
                   $(".nombre-alumno").text($(this).closest('td').prev('td').prev('td').prev('td').prev('td').text());
                	$("#id_actividades").val(id);
		$('.line.' + id).show();
    	$('#del').modal('show');
