        ...
        <div class="box col-md-12">
			<div class="box-inner">
				<div class="box-header well" data-original-title="">
					<h2><i class="glyphicon glyphicon-user"></i> Administración de tipos de actividades</h2>
						<div class="box-icon">
			...
			<div class="box-content">
				<div id="DataTables_Table_0_wrapper" class="dataTables_wrapper" role="grid">
					<div class="row" style="text-align: right;">
							...
							<div class="col-md-12">
								<a class="btn btn-success altaactividades" href="#"><i class="glyphicon glyphicon-plus-sign icon-white"></i> Nuevo tipo de actividad</a>
							</div>
					</div>
					<?php $this->load->view('componentes/baja_masiva', array('entidad' => 'tipo_actividades')); ?>
						<div class="table-wrapper">
							<div class="scrollable">
								<table class="table table-striped table-bordered bootstrap-datatable datatable responsive dataTable tabla-baja-masiva" id="DataTables_Table_0" data-entidad="tipo_actividades" aria-describedby="DataTables_Table_0_info">
									<thead>
										<tr role="row">
										...
										<th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Role: activate to sort column ascending" style="width: 88px;">Directa/Indirecta</th>
					...
					if (!isset($tipo_actividades)) {
						...
						$i = 1;
							...
							foreach ($tipo_actividades as $actividad) {
								...
								echo '<td class="center"><input type="checkbox" class="baja-masiva-fila" value="'.$actividad->id_tipo_actividades.'"></td>';
								echo '<td class=" sorting_1">'.$actividad->descripcion.'</td>';
								echo '<td class="center ">'.$actividad->directa.'</td>';
								
								echo '<td class="center ">
										<a class="btn btn-info btn-editrow" id="'.$actividad->id_tipo_actividades.'"  href="#">
										<i class="glyphicon glyphicon-edit icon-white"></i>
										Editar
										</a>
										<a class="btn btn-deleterow btn-danger" id="'.$actividad->id_tipo_actividades.'" href="#">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                		...
                		<p>Está a punto de eliminar el tipo de actividad <span class="nombre-tipo-actividad"></span></p>
                ...
                <div class="modal-footer">
						...
						<div>
                	<form action="<?php echo base_url().'index.php/administracion/bajatipoactividades';?>" class="form-horizontal" method="post" accept-charset="utf-8">
                    	<a href="#" class="btn btn-default cancelar" data-dismiss="modal">Cancelar</a>
						 <input type="hidden" id="id_tipo_actividades" name="id_tipo_actividades"  maxlength="100" size="50"  class="form-control hidden">
...
<script> 
    ...
    $('.btn-deleterow').click(function() {  // acá le decimos que al clickear eliminar, le pase el id, que se generó también como clase CSS en los <p> del popup y lo muestre
    	var id = $(this).attr('id');
                   ...
                   $(".nombre-tipo-actividad").text($(this).closest('td').prev('td').prev('td').text());
                	$("#id_tipo_actividades").val(id);
		$('.line.' + id).show();
    	$('#del').modal('show');
    ...
    $(document).on('click','.btn-editrow', function (e) {
        ...
        var id = "id_tipo_actividades="+$(this).attr('id');
		$('#formulario').html('<img src="<?php echo base_url();?>static/img/ajax-loader-1.gif">');
		$.ajax({
			type : "POST",
			url : "<?php echo site_url("administracion/altaactividades?uid="); ?>"+Math.random(),
			data: id,
	...
	$(document).on('click','.altaactividades', function (e) {
